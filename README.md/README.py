...
### 2. Root Cause Analysis (Python / SciPy)
...
### 3. Process Control Visualization (Matplotlib)
...
![Six Sigma p-Chart](assets/six_sigma_p_chart_portfolio.png)
...
---
**Author:** Ansaf Mustafa | B.Tech Production & Industrial Engineering